...
const navItems = [
  ...
  { id: 'contenidos', label: 'Contenidos y niveles' },
  { id: 'precios', label: 'Precios' },
  { id: 'contacto', label: 'Contacto' },
];

const INSTAGRAM_HANDLE = '@lucamartinezmath';

function InstagramIcon() {
  return (
    <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor" aria-label="Instagram">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-18">
          <a
            ...
            aria-label="Instagram de Luca Martínez"
          >
            <span className="text-primary-600 transition-transform duration-300 group-hover:scale-110">
              <InstagramIcon />
            </span>
